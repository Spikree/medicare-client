...
const PatientDetails = () => {
  ...
  const { getPatientDetails, patientDetailsList, uploadLabResults, getPatientLabResults, patientLabResults } =
    DoctorStore();
    ...
    {patientLabResults && patientLabResults.length > 0 ? (
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {patientLabResults.map((labResult) => (
          <Card key={labResult._id} className="hover:shadow-md transition-shadow">
